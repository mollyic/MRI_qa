...
# os.makedirs("MRI_rating_record/", exist_ok=True)
...
try:
    for filepath in files:
        ...
        ratings_table.insert(filepath= filepath, rating=ratings['rating'], date=date, susceptibility=ratings['S'], motion=ratings['M'], flow=ratings['F'])
...
field_info = ['filepath','rating', 'date', 'susceptibility', 'motion', 'flow']
